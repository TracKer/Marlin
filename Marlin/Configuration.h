 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 404.20177 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -55, -13, -1.56 }
...
#define Y_BED_SIZE 235 - ABS(MANUAL_Y_HOME_POS)

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS 0
#define Y_MIN_POS 0// + ABS(MANUAL_Y_HOME_POS)
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE
#define Y_MAX_POS Y_BED_SIZE// - ABS(MANUAL_Y_HOME_POS)
